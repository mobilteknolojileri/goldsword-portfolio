...
const Experience = () => {
  ...
  const { ref: internshipRef, isVisible: internshipVisible } =
  ...
  return (
    ...
    >
      <div className="section-container section-padding">
        <h2
          ref={titleRef}
          className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-8 sm:mb-12 md:mb-16 text-heading tracking-tight transition-all duration-700 ${
            titleVisible
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            <div
              ref={educationRef}
              className={`bg-white dark:bg-dark-900 p-4 sm:p-6 md:p-8 rounded-xl shadow-sm border border-gray-200 dark:border-dark-700 transition-all duration-700 ${
                educationVisible
                  ? "opacity-100 translate-x-0"
                  : "opacity-0 -translate-x-10"
              }`}
            >
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 text-heading">
                Mobil Teknolojileri
              </h3>
              <p className="text-primary-600 font-semibold mb-2 text-base sm:text-lg">
                Trakya Üniversitesi
              </p>
            ...
            <div
              ref={internshipRef}
              className={`bg-white dark:bg-dark-900 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-dark-700 transition-all duration-700 delay-150 ${
                internshipVisible
                  ? "opacity-100 translate-x-0"
                  : "opacity-0 translate-x-10"
              }`}
            ...
            <div
              ref={statsRef}
              className={`bg-gradient-to-r from-primary-600 to-accent-600 p-6 rounded-xl text-white shadow-lg transition-all duration-700 delay-300 ${
