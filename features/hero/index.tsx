...
const Hero = () => {
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center justify-center pt-20 gradient-bg overflow-hidden"
    >
      <div className="section-container section-padding w-full">
        <div className="text-center w-full">
          ...
          <div className="flex justify-center mb-8 md:mb-12 px-4">
            <Link href="/portfolio" className="w-full max-w-sm">
              <button className="group relative w-full px-8 py-5 bg-gradient-to-r from-primary-600 via-accent-600 to-primary-600 bg-size-200 bg-pos-0 hover:bg-pos-100 text-white text-xl font-extrabold rounded-2xl shadow-[0_15px_40px_rgba(var(--primary-rgb),0.4)] hover:shadow-[0_20px_50px_rgba(var(--primary-rgb),0.6)] transition-all duration-500 transform hover:scale-105 active:scale-95">
                <span className="flex items-center justify-center gap-4">
                  <svg
                    className="w-7 h-7 flex-shrink-0 animate-bounce-horizontal"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  <svg
                    className="w-6 h-6 flex-shrink-0 group-hover:translate-x-2 transition-transform duration-300"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 max-w-4xl mx-auto px-4 pb-8 md:pb-12">
            <div className="bg-white/80 dark:bg-dark-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-lg border border-gray-200 dark:border-dark-700 hover:shadow-xl transition-shadow">
              ...
              <p className="text-xs sm:text-sm md:text-base text-body mt-2">
                Proje
              </p>
            </div>
            <div className="bg-white/80 dark:bg-dark-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-lg border border-gray-200 dark:border-dark-700 hover:shadow-xl transition-shadow">
