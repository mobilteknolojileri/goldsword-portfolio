...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      content:
        "Ellerine sağlık hızlı ve çok güzel bir site oldu tam istediğim gibi oldu",
    },
    {
      name: "ocbslim",
      ...
      rating: 5,
      content:
        "Gercekten bilgili ve istenileni cok hizli sekilde sonuclandiran bir yazilimci. Kesinlikle islerinizi teslim edebilirsiniz. Bundan sonra hep beraber olacagiz. Tesekkür ederim.",
    },
    {
      name: "ardaras",
    ...
    },
    {
      ...
      rating: 5,
      content:
        "kafasi calisiyor. sizden tonla detay istemiyor. projeyi iyi kavriyor ve teknik mukemmellik haricinde fikir duzeyinde katki yapiyor. ikinci proje de cok basarili oldu ucuncuyu verdik",
    },
    {
      name: "okankaf",
      profileLink: "https://bionluk.com/okankaf",
    ...
    },
    {
      ...
      rating: 5,
      content:
        "istediğimden erken bitti soru cevap ilğili tüm sorunları ve diğer sorunlara odak tanıması güzeldi yine çalışmak isterim",
    },
    {
      name: "siete7",
      profileLink: "https://bionluk.com/siete7",
    ...
    },
    {
      ...
      rating: 5,
      content:
        "basarili ve profesyonel freelancer. . projeyi anlastigimiz sekilde ve zamanda  tamamladi",
    },
    {
      name: "erenardic",
      profileLink: "https://bionluk.com/erenardic",
    ...
    },
    {
      ...
      rating: 5,
      content:
        "uygulama tasarımı işi verildi güzel bir iş çıkardı iletişimi iyiydi eline sağlık",
    },
    {
      name: "okankaf",
      profileLink: "https://bionluk.com/okankaf",
  ...
  return (
    <section
      id="testimonials"
      className="py-12 sm:py-16 md:py-20 bg-white dark:bg-dark-800"
    >
      <div className="section-container section-padding">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-8 sm:mb-12 md:mb-16 text-heading tracking-tight">
          Müşteri Yorumları
        </h2>
