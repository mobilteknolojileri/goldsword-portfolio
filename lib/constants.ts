...
export const PROJECTS = [
  ...
  },
  {
    ...
    challenges:
      "YOLOv8 özel eğitim, TFLite optimizasyon, mobil-backend entegrasyon, tespit doğruluğu",
    links: [],
    screenshots: [
  ...
  },
  {
    ...
    description:
      "XML modernizasyon, Çoklu dil entegrasyonu (Arapça RTL, EN, DE, FR)",
    category: "Mobile",
  ...
  },
  {
    ...
    challenges:
      "Kod tabanı koruma, veri kaybı önleme, dark mode fix, performans artırma",
    links: [],
    screenshots: [
  ...
  },
  {
    ...
    description:
      "Ödeme takibi, görev yönetimi - Drag & Drop, otomatik gecikme tespiti",
    category: "Web",
    technologies: [
      "Next.js 15",
      "TypeScript",
