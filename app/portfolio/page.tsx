        ...
        <div className="section-container section-padding">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-body max-w-3xl mx-auto">
              12+ farklı alanda tamamladığım projeler. Her biri gerçek
              müşteriler için geliştirilmiş, üretim ortamında çalışan
              projelerdir.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3 mb-12 max-w-6xl mx-auto">
            {categories.map((category) => (
              <button
                ...
                className={`px-4 py-2.5 rounded-full font-semibold transition-all text-sm sm:text-base ${
            ...
            {filteredProjects.map((project, index) => (
              <Card key={index} hover className="h-full">
                <div className="group h-full flex flex-col">
                  <div
                    className={`h-56 bg-gradient-to-br ${project.color} rounded-t-xl relative overflow-hidden flex-shrink-0`}
                  >
                    {project.image ? (
                      <Image
                        src={project.image}
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    {project.slug ? (
                      ...
                      <button
                        disabled
                        className="w-full py-2.5 bg-gray-400 dark:bg-gray-700 text-gray-600 dark:text-gray-400 font-semibold rounded-lg cursor-not-allowed opacity-60"
                      >
                        Yakında
                      </button>
                    )}
