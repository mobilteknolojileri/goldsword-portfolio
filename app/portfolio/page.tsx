...
export default function PortfolioPage() {
    ...
    const categories = ['All', 'Mobile', 'Web', 'Game', 'Backend', 'SEO', 'Design']
                                ...
                                <div className="group h-full flex flex-col">
                                    ...
                                    <div className="p-6 flex flex-col flex-1">
                                        ...
                                        {project.slug ? (
                                            ...
                                            <button disabled className="w-full py-2.5 bg-gray-400 dark:bg-gray-700 text-gray-600 dark:text-gray-400 font-semibold rounded-lg cursor-not-allowed opacity-60">
                                                Yakında
                                            </button>
                                        )}
                                    </div>
