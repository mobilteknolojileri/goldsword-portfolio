                ...
                <div className="bg-white dark:bg-dark-800 p-6 rounded-xl shadow-md border border-gray-200 dark:border-dark-700">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {project.screenshots.map((screenshot, index) => (
                      <div
                        key={index}
                        className="relative aspect-[9/16] rounded-lg overflow-hidden border-2 border-gray-200 dark:border-dark-700 hover:border-primary-500 dark:hover:border-primary-500 transition-colors bg-gray-100 dark:bg-dark-900"
                      >
                        <Image
                          src={screenshot}
