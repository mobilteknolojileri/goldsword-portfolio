...
const features = [
  ...
  },
  {
    ...
    description:
      "Gizli notlarınız ve günlükleriniz AES-256 ile koruma altında.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
    ...
    <div className="max-w-5xl mx-auto px-4 pb-20">
      ...
      <section className="text-center pt-10 pb-20 overflow-hidden relative">
        ...
        <p className="text-xl md:text-2xl text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed">
          Fotoğraf gizleme, gizli şifre ve not günlüğü. Modern güvenlik
          standartlarıyla korunan dijital kasanız.
        </p>
      ...
      <section className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-32">
        {features.map((feature, i) => (
          <div
            key={i}
            className="group p-8 rounded-3xl bg-slate-800/30 border border-slate-700/50 hover:border-indigo-500/50 transition-all hover:bg-slate-800/50"
          >
      ...
      <section className="bg-gradient-to-br from-indigo-900/40 to-slate-900/40 rounded-[2.5rem] border border-indigo-500/20 p-10 md:p-16 mb-20 relative overflow-hidden text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-slate-300 mb-12">
            Bankalarla aynı şifreleme standardını (AES-256) kullanan QuSafe,
            verilerinizin asla şifresiz olarak cihazdan çıkmamasını sağlar.
          </p>
