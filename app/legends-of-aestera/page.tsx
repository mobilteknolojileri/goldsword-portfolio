...
const features = [
  {
    title: "İki Kahraman",
    description:
      "Red (kılıç) ve Robinhood (ok) karakterleri arasında seçim yapın.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
      ...
      >
        <path
          ...
          strokeWidth={1.5}
          d="M12 4.354l1.1 3.383h3.558l-2.877 2.09 1.1 3.383-2.877-2.09-2.877 2.09 1.1-3.383-2.877-2.09h3.558L12 4.354z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    description:
      "Zıplayan variller, testereler ve dikenli engellerle dolu 6+ el yapımı seviye.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Mobil cihazlar için optimize edilmiş pürüzsüz dokunmatik kontroller.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Canlı renkler ve detaylı piksel çizimleriyle modern bir retro deneyimi.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Her seviyede strateji gerektiren farklı düşman türleri ve mekanikler.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Reflekslerinizi ve stratejinizi test eden destansı karşılaşmalar.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
    ...
    <div className="max-w-5xl mx-auto px-4 pb-20">
      ...
      <section className="text-center pt-10 pb-20 overflow-hidden relative">
        ...
        <p className="text-xl md:text-2xl text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed">
          Kılıç ve yayın gücüyle destansı bir maceraya atılın. Piksel art
          dünyasında düşmanları alt edin ve efsanenizi yazın.
        </p>
      ...
      <section className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-32">
        {features.map((feature, i) => (
          <div
            key={i}
            className="group p-8 rounded-3xl bg-slate-800/30 border border-slate-700/50 hover:border-red-500/50 transition-all hover:bg-slate-800/50"
          >
      ...
      <section className="bg-gradient-to-br from-red-900/40 to-slate-900/40 rounded-[2.5rem] border border-red-500/20 p-10 md:p-16 mb-20 relative overflow-hidden text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-8">
            Piksel Macerası Başlıyor
          </h2>
          <p className="text-lg text-slate-300 mb-12">
            Legends of Aestera, retro ruhunu modern mekaniklerle birleştiriyor.
            Her seviye oyuncuyu farklı bir stratejiye zorlayan el yapımı
            tasarımlara sahiptir.
          </p>

          <div className="flex justify-center gap-4">
            <div className="px-6 py-3 rounded-full bg-red-500/20 text-red-400 border border-red-500/30 font-semibold">
              Unity Engine
            </div>
            <div className="px-6 py-3 rounded-full bg-orange-500/20 text-orange-400 border border-orange-500/30 font-semibold">
              IL2CPP
            </div>
          </div>
        </div>
